...
def index(request):
    ...
    try:
        ...
        print('No data.')
    return render(request, 'bajetiapp/index.html',context={'user':request.user,'expense_items':expense_items,'budget_total':budget_total,'expense_total':expense_total})
